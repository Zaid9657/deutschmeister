...
| D | Abschlusstest A1.2 (SD1 format, half length) on the mock runner; 28-day A1.2 plan page (`/a1-2-phase`, paid gate); runner `questionMax` filter so course-test Hören parts stay at 10 items now that exercises carry 23 questions | PR open | — |
