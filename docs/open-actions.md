...
| O-8 | Run `scripts/generate-example-audio.mjs` with an Azure Speech key (free tier covers it; switched from OpenAI 2026-09-05) — 0/757 grammar examples and 0/2215 words have audio; the script covers both tables and is resumable | `AUDIT-2026-08-16.md` P2; roadmap §3.4 | 2026-08-16 |
...
| O-16 | **Level courses go-live** — DONE 2026-09-03 except two dashboard lines: product 1336941 created (5 variants), ten env vars set, deployed, test purchase verified (order 9377799 → `course_a1` row). **Remaining (extension):** set the product's redirect URL to `/subscription/success`; deactivate discount 1120253. Prompts: `docs/owner-prompts.md` | `docs/monetization-2026-09-03.md` | 2026-09-03 |
