...
| O-16 | **Level courses go-live** (monetization decision A, `docs/monetization-2026-09-03.md`): create the five LS one-time products (4 × €49 bands + €129 bundle), send both ids per product (numeric variant + checkout UUID); the agent then sets the ten env vars via the Netlify connector and redeploys. Then **one test-mode purchase** — purchase → `purchases` row → level opens → refund re-locks — before any launch email | `docs/monetization-2026-09-03.md` | 2026-09-03 |
