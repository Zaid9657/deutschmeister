...
const slugs = ['adjective-endings-intro', 'pronouns-accusative-dative', 'modal-verbs-past', 'temporal-prepositions'];
...
for (const slug of slugs) {
  ...
  await page.screenshot({ path: `${outDir}/pr-a-${slug}.png`, fullPage: true });
