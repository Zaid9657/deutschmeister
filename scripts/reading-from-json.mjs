// Generate migrations/2026-09-05-a1-1-reading.sql from the two review JSON
// files (Course Factory Wave 2, PR C):
//
...
const sql = `-- A1.1 reading: 8 rewritten lessons get auto-checkable "checks" items
