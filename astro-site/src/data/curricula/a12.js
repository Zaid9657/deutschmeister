...
//                                 Charakter beschreibt man mit sein + Nominativ.
  ...
  lektionen: [
    {
      ...
      dialog: {
        ...
        lines: [
          ...
          { speaker: 'Frau Fischer', de: 'Ja. Neben der Apotheke ist die Bank.', en: 'Yes. The bank is next to the pharmacy.' },
          { speaker: 'Ana', de: 'Wo ist die Haltestelle für die Straßenbahn in der Stadt?', en: 'Where is the tram stop in town?' },
          { speaker: 'Frau Fischer', de: 'Am Platz. Danach kommt die Brücke.', en: 'At the square. After that comes the bridge.' },
          { speaker: 'Ana', de: 'Und die U-Bahn? Fährt sie ins Zentrum?', en: 'And the metro? Does it go to the centre?' },
          { speaker: 'Frau Fischer', de: 'Ja. Zuerst rechts, dann sind Sie im Zentrum.', en: 'Yes. First right, then you are in the centre.' },
        ],
      },
      pretest: {
      ...
      links: { listeningExercise: 2, readingOrder: 7 },
    ...
    },
    {
      ...
      examTeile: ['Lesen Teil 2', 'Schreiben Teil 2', 'Sprechen Teil 2'],
      ...
      dialog: {
        ...
        lines: [
          ...
          { speaker: 'Herr Berg', de: 'Die Miete ist 480 Euro im Monat. Der Keller kostet 20 Euro.', en: 'The rent is 480 euros a month. The basement costs 20 euros.' },
          ...
          { speaker: 'Herr Berg', de: 'Ja, ein Balkon. Die Wohnung ist im dritten Stockwerk.', en: 'Yes, a balcony. The flat is on the third floor.' },
          { speaker: 'Ana', de: 'Ist die Treppe im Haus? Ich habe viele Bücher.', en: 'Are the stairs inside the house? I have a lot of books.' },
          { speaker: 'Herr Berg', de: 'Ja. Die erste Wohnung ist frei, die Nachbarin ist Studentin.', en: 'Yes. The first flat is free, the neighbour is a student.' },
        ],
      },
      pretest: {
      ...
      notice: {
        ...
        examples: ['Die Miete ist 480 Euro im Monat. Der Keller kostet 20 Euro.', 'Ja, ein Balkon. Die Wohnung ist im dritten Stockwerk.'],
    ...
    },
    {
      ...
      dialog: {
        ...
        lines: [
          ...
          { speaker: 'Ana', de: 'Ich brauche einen Supermarkt und einen Markt im Zentrum.', en: 'I need a supermarket and a market in the centre.' },
          { speaker: 'Lena', de: 'Der Markt am Park hat auch Brot. Gehst du?', en: 'The market by the park has bread too. Are you going?' },
          { speaker: 'Ana', de: 'Ja. Danach brauche ich das Geld für das Museum.', en: 'Yes. After that I need the money for the museum.' },
          { speaker: 'Lena', de: 'Bezahlst du an der Kasse? Die Quittung ist für dich.', en: 'Are you paying at the till? The receipt is for you.' },
          { speaker: 'Ana', de: 'Ja. Ich bezahle das Kilo Brot an der Kasse.', en: 'Yes. I pay for the kilo of bread at the till.' },
          ...
          { speaker: 'Ana', de: 'Zuerst das Museum, dann das Restaurant im Park.', en: 'First the museum, then the restaurant in the park.' },
          { speaker: 'Lena', de: 'Meine Schule ist neben dem Krankenhaus. Ich komme später.', en: 'My school is next to the hospital. I will come later.' },
      ...
      pretest: {
        ...
        accepted: ['Ich brauche', 'Ich suche', 'Ich kaufe'],
      },
      notice: {
        title: 'Der Akkusativ: den, einen, keinen',
        bodyDe: 'Viele Verben verlangen ein Objekt im Akkusativ: **brauchen**, **kaufen**, **bezahlen**. Nur der Maskulinum ändert die Form: der Markt → **den** Markt, ein Supermarkt → **einen** Supermarkt, kein Park → **keinen** Park. Feminin, Neutrum und Plural bleiben gleich: die Quittung, das Geld, die Museen.',
        examples: ['Ich brauche einen Supermarkt und einen Markt im Zentrum.', 'Bezahlst du an der Kasse? Die Quittung ist für dich.'],
        ruleSlug: 'accusative-intro',
      },
      phonetik: { focus: 'Die Endung -en klingt kurz: einen, keinen', items: ['ei-nen MARKT', 'kei-nen PARK', 'den SU-per-markt'] },
      hoeren: { kind: 'dictation', lines: [1, 5] },
      sprechen: {
        readAloud: [4, 7],
        open: {
    ...
    },
    {
      ...
      dialog: {
        ...
        setting: 'Ana wohnt im Hotel. Frau Kaya arbeitet an der Rezeption.',
        lines: [
          ...
          { speaker: 'Ana', de: 'Nein. Im Flur ist keine Lampe und kein Spiegel.', en: 'No. In the hallway there is no lamp and no mirror.' },
          ...
          { speaker: 'Ana', de: 'Und die Rechnung? Gibt es einen Rabatt für mich?', en: 'And the bill? Is there a discount for me?' },
      ...
      notice: {
        ...
        examples: ['Nein. Im Flur ist keine Lampe und kein Spiegel.', 'Das Kissen ist da, aber die Steckdose funktioniert nicht.'],
        ruleSlug: 'negation',
      },
    ...
    },
    {
      ...
      dialog: {
        ...
        lines: [
          ...
          { speaker: 'Tim', de: 'Ja. Wohin fahren wir? Ich habe den Fahrplan.', en: 'Yes. Where are we going? I have the timetable.' },
          { speaker: 'Lena', de: 'Wann fährt der Zug? Um wie viel Uhr?', en: 'When does the train leave? At what time?' },
          { speaker: 'Tim', de: 'Früh. Wir sind in zwei Stunden am Konzert.', en: 'Early. We will be at the concert in two hours.' },
      ...
      notice: {
        ...
        bodyDe: 'In der W-Frage steht das Fragewort auf Position 1 und das Verb direkt dahinter: **Wann** fährt der Zug? **Wohin** fahren wir? **Wie oft** kommt der Bus? **Wer** fragt nach der Person, **was** nach der Sache, **wo** nach dem Ort, **wohin** nach der Richtung, **warum** nach dem Grund, **wie lange** nach der Dauer.',
      ...
      schreiben: {
        kind: 'formular',
        taskKey: 'a12-l05',
        taskDe: 'Tim Berger fährt am Samstag zum Konzert nach Köln. Der Zug fährt um 8 Uhr. Er bleibt zwei Tage. Füllen Sie das Formular für den Ausflug aus.',
        fields: ['Name', 'Tag', 'Uhrzeit', 'Stadt', 'Unterschrift'],
        minWords: 5,
        maxWords: 40,
        sample: 'Name: Tim Berger / Tag: Samstag / Uhrzeit: 8 Uhr / Stadt: Köln / Unterschrift: T. Berger',
      },
      links: { listeningExercise: 3, readingOrder: 5 },
    ...
    },
    {
      ...
      examTeile: ['Hören Teil 3', 'Sprechen Teil 1', 'Schreiben Teil 2'],
      ...
      dialog: {
        ...
        lines: [
          ...
          { speaker: 'Ana', de: 'Ich schlafe nicht gut. Mein Mann schläft auch nicht.', en: 'I do not sleep well. My husband does not sleep either.' },
          ...
          { speaker: 'Ana', de: 'Wie oft nimmt man die Tablette?', en: 'How often does one take the tablet?' },
          { speaker: 'Frau Berger', de: 'Am Morgen und am Abend. Das ist gesund.', en: 'In the morning and in the evening. That is healthy.' },
          { speaker: 'Ana', de: 'Und mein Zahn? Der Rücken und der Bauch sind krank.', en: 'And my tooth? My back and my stomach are unwell.' },
          { speaker: 'Frau Berger', de: 'Ihr Auge sieht gut. Die Hand und der Fuß sind gesund.', en: 'Your eye looks fine. The hand and the foot are healthy.' },
      ...
      pretest: {
        ...
        accepted: ['Mein', 'Meine', 'Ich habe'],
      },
      notice: {
        title: 'Verben mit Vokalwechsel',
        bodyDe: 'Einige Verben ändern im Präsens den Stammvokal, aber nur in der **du**-Form und in der **er/sie/es**-Form: nehmen → er **nimmt**, helfen → sie **hilft**, sehen → er **sieht**, schlafen → er **schläft**, essen → sie **isst**, sprechen → er **spricht**. Bei ich, wir, ihr und Sie bleibt der Vokal: ich **nehme**, wir **nehmen**.',
        examples: ['Sie nehmen eine Tablette. Die Tablette hilft gegen Kopfschmerzen.', 'Ihr Auge sieht gut. Die Hand und der Fuß sind gesund.'],
      ...
      sprechen: {
        ...
        open: {
          ...
          promptDe: 'Melden Sie sich in der Praxis an: Name, Termin und Beschwerden.',
    ...
    },
    {
      ...
      examTeile: ['Lesen Teil 2', 'Sprechen Teil 2', 'Schreiben Teil 1'],
      ...
      notice: {
        ...
        bodyDe: 'Das Subjekt eines Satzes steht im Nominativ. Man findet es mit **wer** (Person) oder **was** (Sache): **Wer** ist das? — **Mein Onkel** ist groß. Nach **sein** steht das zweite Nomen ebenfalls im Nominativ: Das ist **mein Bruder**. Die Artikel im Nominativ: **der** Opa, **die** Oma, **das** Kind, im Plural **die** Kinder.',
      ...
      phonetik: { focus: 'Langer und kurzer Vokal: lang – kurz', items: ['LANG', 'KURZ', 'GROSS'] },
      hoeren: { kind: 'dictation', lines: [1, 5] },
      sprechen: {
        readAloud: [0, 9],
        open: {
          teil: 'Sprechen Teil 2',
          promptDe: 'Sprechen Sie über eine Person in Ihrer Familie: Aussehen und Charakter.',
          hintWords: ['die Tante', 'groß', 'glücklich'],
          missionOrder: 2,
        },
      },
      schreiben: {
        kind: 'formular',
        taskKey: 'a12-l07',
        taskDe: 'Lena Berg ist 24 Jahre alt und kommt aus Köln. Sie ist groß und hat lange Haare. Ihr Hobby ist Musik. Füllen Sie den Steckbrief für den Kurs aus.',
        fields: ['Name', 'Alter', 'Stadt', 'Aussehen', 'Hobby'],
        minWords: 5,
        maxWords: 40,
        sample: 'Name: Lena Berg / Alter: 24 / Stadt: Köln / Aussehen: groß, lange Haare / Hobby: Musik',
      },
    ...
    },
    {
      ...
      examTeile: ['Hören Teil 2', 'Sprechen Teil 3', 'Schreiben Teil 2'],
      ...
      dialog: {
        ...
        lines: [
          ...
          { speaker: 'Lena', de: 'Nein, komm jetzt! Im Kühlschrank ist kein Brot.', en: 'No, come now! There is no bread in the fridge.' },
          { speaker: 'Tim', de: 'Gut. Wo sind die Möbel für das Kinderzimmer?', en: 'Fine. Where is the furniture for the children’s room?' },
          { speaker: 'Lena', de: 'Das Sofa und der Schrank sind in der Garage.', en: 'The sofa and the wardrobe are in the garage.' },
          { speaker: 'Tim', de: 'Und das Bett? Warte, ich frage den Nachbarn.', en: 'And the bed? Wait, I will ask the neighbour.' },
          { speaker: 'Lena', de: 'Gut. Der Teppich ist auf der Terrasse. Hol ihn!', en: 'Good. The carpet is on the terrace. Get it!' },
          { speaker: 'Tim', de: 'Und der Herd? Der Fernseher steht unter dem Dach.', en: 'And the stove? The television is up under the roof.' },
          { speaker: 'Lena', de: 'Mach den Fernseher aus und hilf mir bitte!', en: 'Turn off the television and help me, please!' },
          { speaker: 'Tim', de: 'Ja, ja. Ich komme jetzt. Warte kurz!', en: 'Yes, yes. I am coming now. Wait a moment!' },
        ],
      },
      pretest: {
        promptDe: 'Bitten Sie eine Kollegin höflich um Hilfe im Haushalt.',
        promptEn: 'Politely ask a colleague for help with the housework.',
        model: 'Helfen Sie mir bitte!',
        accepted: ['Helfen Sie', 'Bitte', 'Machen Sie'],
      },
      notice: {
        title: 'Der Imperativ: bitten und auffordern',
        bodyDe: 'Der Imperativ steht auf Position 1. Bei **Sie** bleibt das Pronomen stehen: **Helfen Sie** bitte! Bei **du** fällt das Pronomen weg und die Endung -st fällt mit: **Komm!**, **Warte!**, **Hilf!** Trennbare Verben schicken die Vorsilbe ans Ende: **Mach** den Fernseher **aus**! Das Wort **bitte** macht jede Aufforderung höflich.',
      ...
      sprechen: {
        ...
        open: {
          teil: 'Sprechen Teil 3',
          promptDe: 'Formulieren Sie drei höfliche Bitten im Haushalt und reagieren Sie auf eine Bitte.',
    ...
    },
    {
      ...
      dialog: {
        ...
        lines: [
          ...
          { speaker: 'Ana', de: 'Gut. Ich will auch zum Flughafen. Wie lange?', en: 'Fine. I also want to go to the airport. How long does it take?' },
          ...
          { speaker: 'Herr Schmidt', de: 'Hier. Sie dürfen mit dem Koffer nicht laufen.', en: 'Here. You may not run with the suitcase.' },
          { speaker: 'Ana', de: 'Und wo muss ich aussteigen? Am Flughafen?', en: 'And where do I have to get off? At the airport?' },
      ...
      notice: {
        ...
        bodyDe: 'Das Modalverb steht auf Position 2, das zweite Verb im Infinitiv ganz am Ende: Hier **dürfen** Sie nicht **fahren**. **können** heißt Fähigkeit, **müssen** Notwendigkeit, **dürfen** Erlaubnis, **wollen** Absicht, **sollen** Auftrag. In der ich-Form und in der er-Form fehlt die Endung: ich **kann**, er **muss**, sie **darf**.',
      ...
      schreiben: {
        kind: 'formular',
        taskKey: 'a12-l09',
        taskDe: 'Ana Chakiri fliegt am 14. Juli nach Marokko. Sie hat einen Koffer und fährt mit dem Taxi zum Flughafen. Füllen Sie das Formular für die Reise aus.',
        fields: ['Name', 'Datum', 'Land', 'Koffer', 'Unterschrift'],
        minWords: 5,
        maxWords: 40,
        sample: 'Name: Ana Chakiri / Datum: 14. Juli / Land: Marokko / Koffer: 1 / Unterschrift: A. Chakiri',
      },
    ...
    },
    {
      ...
      dialog: {
        ...
        lines: [
          ...
          { speaker: 'Ana', de: 'Ich trage gern eine Hose und ein Hemd.', en: 'I like wearing trousers and a shirt.' },
      ...
      notice: {
        ...
        bodyDe: 'Nach **für**, **ohne**, **gegen**, **um** und **durch** steht immer der Akkusativ: **für den** Bruder, **ohne den** Schal, **durch das** Kaufhaus. Beim Vergleich hilft **als**: Die Mütze ist billig**er als** der Schal. Das Kleid ist teu**rer**. Unregelmäßig: groß → gr**öß**er, gut → **besser**.',
        examples: ['Größe 50. Ohne den Schal ist er billig.', 'Ich kaufe die Mütze für meine Oma.'],
      ...
      sprechen: {
        ...
        open: {
          teil: 'Sprechen Teil 2',
          promptDe: 'Fragen und antworten Sie zum Thema Kleidung: Größe, Farbe, Preis.',
    ...
    },
    {
      ...
      dialog: {
        ...
        setting: 'Tim und Lena sprechen über das Wetter.',
        lines: [
          { speaker: 'Tim', de: 'Wie ist das Wetter im Sommer bei dir?', en: 'What is the weather like in summer where you are?' },
          { speaker: 'Lena', de: 'Im Sommer ist es sonnig, mit vierzig Grad.', en: 'In summer it is sunny, with forty degrees.' },
          { speaker: 'Tim', de: 'Und im Winter? Bei uns schneit es oft.', en: 'And in winter? Where we live it often snows.' },
          { speaker: 'Lena', de: 'Bei uns kommt der Schnee im Winter.', en: 'Where we live the snow comes in winter.' },
          { speaker: 'Tim', de: 'Seit einer Woche regnet es. Es ist wolkig.', en: 'It has been raining for a week. It is cloudy.' },
          { speaker: 'Lena', de: 'Die Wolke ist da und der Wind ist kalt.', en: 'The cloud is there and the wind is cold.' },
          ...
          { speaker: 'Lena', de: 'Die Temperatur ist bei zehn Grad. Es ist nicht warm.', en: 'The temperature is around ten degrees. It is not warm.' },
          { speaker: 'Tim', de: 'Welche Jahreszeit ist bei dir schön?', en: 'Which season is nice where you are?' },
          { speaker: 'Lena', de: 'Der Sommer. Nach dem Regen ist die Sonne da.', en: 'Summer. After the rain the sun is there.' },
        ],
      },
      pretest: {
      ...
      notice: {
        ...
        bodyDe: 'Nach **mit**, **nach**, **bei**, **seit**, **von**, **zu** und **aus** steht der Dativ: mit **dem** Bus, nach **dem** Regen, bei **der** Sonne, seit **einer** Woche. Oft verschmelzen Präposition und Artikel: in dem wird **im** Sommer, an dem wird **am** Abend, zu der wird **zur** Kirche, zu dem wird **zum** Bahnhof.',
        examples: ['Seit einer Woche regnet es. Es ist wolkig.', 'Der Sommer. Nach dem Regen ist die Sonne da.'],
        ruleSlug: 'dative-prepositions-intro',
      },
      phonetik: { focus: 'Langes e und langes o: Schnee, Sonne', items: ['der SCHNEE', 'die SON-ne', 'das WET-ter'] },
      ...
      schreiben: {
        kind: 'formular',
        taskKey: 'a12-l11',
        taskDe: 'Lena Berg macht am Sonntag einen Ausflug. Am Sonntag ist es sonnig, die Temperatur ist bei 22 Grad. Sie fährt mit dem Bus. Füllen Sie das Formular für den Ausflug aus.',
        fields: ['Name', 'Tag', 'Wetter', 'Temperatur', 'Unterschrift'],
        minWords: 5,
        maxWords: 40,
        sample: 'Name: Lena Berg / Tag: Sonntag / Wetter: sonnig / Temperatur: 22 Grad / Unterschrift: L. Berg',
      },
    ...
    },
    {
      ...
      canDo: [
        ...
        'Ich kann sagen, was es auf dem Fest zu essen gab.',
        'Ich kann Lebensmittel für ein Fest nennen.',
        'Ich kann sagen, ob etwas lecker war.',
      ],
      examTeile: ['Lesen Teil 1', 'Sprechen Teil 3', 'Schreiben Teil 2'],
      ...
      dialog: {
        ...
        lines: [
          ...
          { speaker: 'Ana', de: 'Das Obst und die Kartoffel habe ich gekauft.', en: 'I bought the fruit and the potato.' },
          { speaker: 'Lena', de: 'Die Nudeln und den Reis hat Tim gekocht.', en: 'Tim cooked the noodles and the rice.' },
          { speaker: 'Ana', de: 'Der Zucker im Kuchen war zu viel!', en: 'There was too much sugar in the cake!' },
        ],
      },
      pretest: {
      ...
      sprechen: {
        ...
        open: {
          teil: 'Sprechen Teil 3',
          promptDe: 'Laden Sie eine Kollegin zum Fest ein und reagieren Sie auf eine Absage.',
