...
| `2026-08-19-unpublish-broken-podcasts.sql` | Unpublishes the 10 of 24 podcasts whose `audio_url` returns `NoSuchKey` (all of B1.2/B2.1/B2.2 plus B1.1 #3) — they were listed on-site and in the public RSS feed and every one 404'd. Documents the separate, still-open problem that the 14 surviving episodes are 117–420 MB **video** files with placeholder durations. | ✅ **Applied 2026-08-19** |
