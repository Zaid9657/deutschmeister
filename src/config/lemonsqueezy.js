...
export const LEMONSQUEEZY_CONFIG = {
  ...
  plans: {
    monthly: {
      ...
      currency: 'EUR',
      interval: 'month',
      variantId: import.meta.env.VITE_LEMONSQUEEZY_MONTHLY_VARIANT_ID || '26273c30-058d-4b1c-bf4d-00dd17714e16',
      features: [
    ...
    yearly: {
      ...
      currency: 'EUR',
      interval: 'year',
      variantId: import.meta.env.VITE_LEMONSQUEEZY_YEARLY_VARIANT_ID || 'd29b6485-ad2e-4827-976d-44e8569cfdfa',
      features: [
