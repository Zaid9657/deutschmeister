...
/** Grammar topics (A1.1, A1.2, A2.1 and A2.2 have 12; every other level has 8). Source: counted against grammar-content-cache.json on 2026-09-06 (Wave 5 PR A). */
export const GRAMMAR_TOPIC_COUNT = 80;
...
/** Grammar rule explanations across all 80 topics. Source: counted against grammar-content-cache.json on 2026-09-06 (Wave 5 PR A2). */
export const GRAMMAR_RULE_COUNT = 621;

/** Worked examples across all 80 topics. Source: counted against grammar-content-cache.json on 2026-09-06 (Wave 5 PR A2). */
export const GRAMMAR_EXAMPLE_COUNT = 873;

/** Interactive exercises across all 80 topics. Source: counted against grammar-content-cache.json on 2026-09-06 (Wave 5 PR A2). */
export const GRAMMAR_EXERCISE_COUNT = 1430;
 ...
 *  = 2390 (2026-09-06); + 171 A2.2 additions (Course Factory Wave 5, PR B, migrations/2026-09-06-a2-2-wortliste.sql) = 2561 (2026-09-06).
 *  NOTE: llms.txt and llms-full.txt claimed 1,982 until 2026-08-24 — overstated by 47. */
export const VOCAB_WORD_COUNT = 2561;
...
export const READING_LESSON_COUNTS_BY_LEVEL = {
  'a1.1': 10, 'a1.2': 10, 'a2.1': 10, 'a2.2': 10,
  'b1.1': 8, 'b1.2': 8, 'b2.1': 8, 'b2.2': 10,
};
/** a1.1 went 8 → 10 with the exam-format lessons added 2026-09-05 (Course
 *  Factory Wave 2, PR C: migrations/2026-09-05-a1-1-reading.sql). a1.2 went
 *  8 → 10 the same way on 2026-09-05 (Course Factory Wave 3, PR C:
 *  migrations/2026-09-05-a1-2-reading.sql), and a2.1 on 2026-09-06 (Course
 *  Factory Wave 4, PR C: migrations/2026-09-06-a2-1-reading.sql). */
export const READING_LESSON_COUNT = 74;
