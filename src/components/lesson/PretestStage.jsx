 ...
 *
 * The prompt is the German `promptDe` as the title with its English twin
 * `promptEn` as the lead — in both chrome languages, because the German line
 * is the task and the English line is what makes it readable on day one.
 */
        ...
        <Card tone="wash" className="mt-4 p-5">
          ...
          {hit && (
            <p className="mt-3 flex items-center gap-2 text-[0.875rem] font-bold text-siegel-deep">
              <Check className="h-4 w-4" aria-hidden="true" /> {t('pretest.goodStart', lang)}
            </p>
          )}
        </Card>
      )}
