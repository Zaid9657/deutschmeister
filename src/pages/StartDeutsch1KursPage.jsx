...
import { PROGRAM, PROGRAM_KEY, allItemIds } from '../data/programs/startDeutsch1';
...
// The course area for "Start Deutsch 1: die 30-Tage-Prüfungsphase": the
// 5-week (30-day) plan over existing A1 content, with a per-item checkbox
// persisted to program_progress (generic by program_key — same table, same
// service, no migration). Structurally identical to TelcB1KursPage.jsx; see
// that file's header for the rationale. Reached via LevelSubscriptionGuard
// (level="a1.2") rather than PurchaseGuard — this plan belongs to the A1
// band (Pro/trial OR the A1 course), not a standalone one-time product.
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        <header className="relative overflow-hidden rounded-clay mb-8 -mx-2 px-2 py-4">
          ...
          <div className="relative">
            <Reveal as="div">
              <Chip tone="label">Start Deutsch 1</Chip>
            </Reveal>
            <Reveal
              as="h1"
              delay={60}
...
export default StartDeutsch1KursPage;
