...
import { PROGRAM, PROGRAM_KEY, allItemIds } from '../data/programs/a21Phase';
...
// The course area for "A2.1-Phase: 28 Tage bis zum Abschlusstest": the
// 4-week (28-day) plan over the FIRST half of the A2 band, ending at the
// Abschlusstest A2.1 course test rather than the real exam (there is no
// Goethe-A2 exam plan yet — Tag 28 hands the learner off to /level/a2.2).
// Structurally identical to A12PhasePage.jsx / A11PhasePage.jsx — same
...
// repeated here. Reached via LevelSubscriptionGuard (level="a2.1") — A2.1 is
// a paid level, so this plan opens only with Pro/trial or the A2 course
// purchase (hasLevelAccess('a2.1')), the same gate the A2.1 level page and
// the Abschlusstest A2.1 use.
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <footer className="border-t border-rule pt-6 text-sm text-graphite">
          <p>
            ...
            Dein Pro-Zugang bzw. dein A2-Kurs deckt jede verlinkte Übung ab; den Status siehst du auf{' '}
